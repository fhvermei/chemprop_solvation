...
from chemprop_solvation.utils import makedirs
from chemprop_solvation.features import get_available_features_generators
...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--save_inchi_split', action='store_true', default=False,
                        help='Save inchi for each train/val/test splits for prediction convenience later')
    ...
    parser.add_argument('--solvation', action='store_true', default=False,
                        help='You want to predict properties including an explicit solvent')
    parser.add_argument('--Tmelt', action='store_true', default=False,
                        help='You want to melting temperature')
    # Training arguments
    parser.add_argument('--epochs', type=int, default=200,
                        help='Number of epochs to run')
    parser.add_argument('--batch_size', type=int, default=50,
                        help='Batch size')
                        # number of samples processed before model is updated, must be lower than number of samples in training set
    ...
    parser.add_argument('--solvation_mol_features', action='store_true', default=False,
                        help='Adds molecule features specific to solvation models')
